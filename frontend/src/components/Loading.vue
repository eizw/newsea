        ...
        <svg class="w-full h-full" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <g id="DarkWaves" class="DarkWaves">
                <g>
                    ...
                    <path class="fill-newsea-primary" d="M761.8,202.4c-24.7,0-36.7,7.2-49.5,14.7c-13.2,7.8-26.8,15.9-53.8,15.9c-27,0-40.6-8.1-53.8-15.9
            ...
            <g id="LightWaves" class="LightWaves">
                <g>
                    <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="300.0005" y1="600" x2="500.0005" y2="214.3545">
                        <stop  offset="0" style="stop-color:#0000FF"/>
                    ...
                    <path class="fill-blue-200" d="M750.9,229.8c-14.8-7.9-28.7-15.4-57.2-15.4c-28.5,0-42.4,7.5-57.2,15.4c-15.2,8.2-30.9,16.6-62.1,16.6
